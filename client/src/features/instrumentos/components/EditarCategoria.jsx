...
export function EditarCategoria({ onClose, onSuccess, enums, categoria }){
    ...
    const [formData, setFormData] = useState({
        ...
        // Campos ESTANDAR
        tipo_proveedor: categoria.tipo_proveedor,
        frecuencia_meses: categoria.frecuencia_meses,
        // Campos PROBADOR
        usos_maximos: categoria.usos_maximos,
    });
    ...
    const handleSubmit = async (e)=>{
        ...
        try{
            ...
            const payload = {
                ...
                frecuencia_meses: formData.frecuencia_meses
            };

            if (payload.tipo === 'PROBADOR') {
                payload.usos_maximos = formData.usos_maximos;
            }

            // Llamada PUT al endpoint con el ID de la categoría
            const response = await apiCall(`${API_URL}/api/instrumentos/categoria/${categoria.id_categoria}`, {
                method: 'PUT',
            ...
            setError(err.message || "Ocurrió un error al actualizar la categoría de instrumentos")
        }finally{
            setLoading(false);
        }
        return null;
